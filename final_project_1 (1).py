...
# Check if keys exist in cv_results_ before printing to avoid KeyError
if f'mean_test_precision' in best_results:
    print(f"Precision: {best_results['mean_test_precision'][grid_search.best_index_]}")
else:
    print("Precision metric is not available in the results.")

if f'mean_test_recall' in best_results:
    print(f"Recall: {best_results['mean_test_recall'][grid_search.best_index_]}")
else:
    print("Recall metric is not available in the results.")

if f'mean_test_f1' in best_results:
    print(f"F1-Score: {best_results['mean_test_f1'][grid_search.best_index_]}")
else:
    print("F1-Score metric is not available in the results.")
...
rf_cv_results = cross_validate(rf_model, features, target, cv=2, scoring=scoring)

# Perform cross-validation on the Gradient Boosting model
gb_cv_results = cross_validate(gb_model, features, target, cv=2, scoring=scoring)
